    ...
    Scaffold(
        ...
        if (state.isLoading) {
            ...
            LazyColumn(
                ...
                item {
                    Card(
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Text(
                                text = "${state.roomName} • ${assign?.subject ?: ""}",
                ...
                // Submissions Header
                item {
                    val submittedCount = state.studentSubmissions.count { it.isSubmitted }
                    val totalCount = state.studentSubmissions.size
                    ...
                    Row(
                        ...
                        Text(
                            text = "تم التسليم: ${Num.formatInt(submittedCount)} من ${Num.formatInt(totalCount)}",
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.primary,
